...
def initialiser_salle(nb_rangees, nb_colonnes, positions_equipements):
    ...
    salle = [None] * nb_rangees
    for i in range(len(salle)):
        salle[i] = [None] * nb_colonnes
    ...
    #   - si capacite == 2, X -> 'D2'
    #   - si capacite == 4, X -> 'D4'
    for position in positions_equipements:
        x, y, capacite = position
        match(capacite):
            case 2:
                salle[x][y] = 'D2'
            case 4:
